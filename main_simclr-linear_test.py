...
def parse_option():
    ...
    parser.add_argument('--model_path', type=str, default='/home/cvteam1/cv-project/cv-project/save/SupCon/pathmnist_models/SimCLR-linear_pathmnist_effnet-b0_lr_0.1_trial_512-featdim/best_model.pth',
